...
- PF1E 中文规则库已发布 2498 个结构化父文档、33585 个检索子块。
- 当前发布版本为 `20260801T134116Z`，包含 `PF1E` 与 `Pathfinder 1E` 显式别名。
- 85 题长期混合检索回归为 Hit@5 100%、MRR 0.8676；30 题结构化专项集为 Hit@5 100%、MRR 0.9361。
